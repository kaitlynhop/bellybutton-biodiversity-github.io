...
function buildCharts(sample) {
  ...
  // Bubble Chart - Bacteria Per Person
    ...
    var metaResultArr = data.metadata.filter(metaObj => metaObj.id == sample);

    // 2. Create a variable that holds the first sample in the metadata array.
    var metaResult = metaResultArr[0];
